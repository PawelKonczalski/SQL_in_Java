...
public class InsertDataInToDB {
    public static void main(String[] args) {
         ...
         *
         * myStmt.executeUpdate("insert into pracownicy values (7, 'Joanna', 'Lisowska')"); - add position to data base
         */
        ...
        try {
            ...
            myStmt.executeUpdate("insert into pracownicy values (8, 'Joanna', 'Lisowska')");
